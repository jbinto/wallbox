  ...
  return <div style={{ height: 350, width: 238, display: "inline-block" }}>
    ...
    >
      <Marker {...getLatLng(location)}>
        {location.directionId.startsWith(westPrefix) && <LeftArrow />}
        {location.directionId.startsWith(eastPrefix) && <RightArrow />}
      </Marker>
    </GoogleMap>
  </div>
}
